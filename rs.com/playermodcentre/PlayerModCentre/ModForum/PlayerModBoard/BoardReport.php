...
if (isset($_POST["submit"])){
    ...
    $stmt = $conn->prepare("SELECT category, `page` FROM threads WHERE threadID = ?");
    ...
    $page = $thread['page'];
    $n = 1; //0 = post (default) 1 = thread
    $message = htmlspecialchars(nl2br($_POST["message"]));
    $stmt = $conn->prepare("INSERT INTO reports (`message`,reported_by,replyID,threadID,thread_post) VALUES(?,?,?,?,?)");
    $stmt->bind_param("siiii",$message,$user['userID'],$replyID,$threadID,$n);
    $stmt->execute();
    mysqli_close($conn);
...
if($thread['isSticky'])
{
    $sticky = '<img src="../PlayerModThread/MessageReport_files/stickied.png" alt="" title="" height="13" width="13">';   
}
if($thread['isLocked'])
{
    $locked = '<img src="../PlayerModThread/MessageReport_files/locked.png" alt="" title="" height="13" width="13">';
}
...
<head>
        ...
        <link media="all" type="text/css" rel="stylesheet" href="../PlayerModThread/MessageReport_files/main.css">
        <link href="../PlayerModThread/MessageReport_files/forum-3.css" rel="stylesheet" type="text/css" media="all">
</head>
                                        ...
                                        <center>
                                                <table cellpadding="0" cellspacing="0">
                                                        <tbody>
                                                                <tr>
                                                                        <td valign="top"><img
                                                                                        src="../PlayerModThread/MessageReport_files/edge_a.jpg"
                                                                                        height="43" hspace="0"
                                                                                        vspace="0" width="100"></td>
                                                                        <td valign="top"><img
                                                                                        src="../PlayerModThread/MessageReport_files/edge_c.jpg"
                                                                                        height="42" hspace="0"
                                                                                        vspace="0" width="400"></td>
                                                                        <td valign="top"><img
                                                                                        src="../PlayerModThread/MessageReport_files/edge_d.jpg"
                                                                                        height="43" hspace="0"
                                                                                        vspace="0" width="100"></td>
                                                                </tr>
                                                        </tbody>
                                                </table>
                                                <table background="../PlayerModThread/MessageReport_files/background2.jpg" border="0"
                                                                                                        ...
                                                                                                        <tr>
                                                                                                                <td
                                                                                                                        ...
                                                                                                                        <center> <b>Runescape
                                                                                                                                ...
                                                                                                                                <br><b>Report</b>
                                                                                                                                <br><a href="../../../../forums/ForumBoard/forumBoard.php?category=<?php echo urldecode($thread["category"]);?>&page=<?php echo urldecode($thread["page"]);?>"
                                                                                                                                        class="c">Back
                                                                                                                                        to
                                                                                                                                        thread</a>
                                                                                                                                <br>
                                                                                                                                ...
                                                                                                                                <center>
                                                                                                                                        ...
                                                                                                                                        <br><a href="../../../../forums/ForumBoard/forumBoard.php?category=<?php echo urldecode($thread["category"]);?>&page=<?php echo urldecode($thread["page"]);?>">Back to thread</a>
                                                                                                                                        <br>
                                                                                                                                        <br>
                                                                                                                                        <font
                                                                                                                                                color="#888888">
                                                ...
                                                <table cellpadding="0" cellspacing="0">
                                                        <tbody>
                                                                <tr>
                                                                        <td valign="bottom">
                                                                                <img src="../PlayerModThread/MessageReport_files/edge_g2.jpg"
                                                                                        height="82" hspace="0"
                                                                                        vspace="0" width="100">
                                                                        </td>
                                                                        <td valign="bottom">
                                                                                ...
                                                                                <img src="../PlayerModThread/MessageReport_files/edge_c.jpg"
                                                                                        height="42" hspace="0"
                                                                                        vspace="0" width="400">
                                                                        </td>
                                                                        <td valign="bottom">
                                                                                <img src="../PlayerModThread/MessageReport_files/edge_h2.jpg"
                                                                                        height="82" hspace="0"
                                                                                        vspace="0" width="100">
                                                                        </td>
                                                                </tr>
