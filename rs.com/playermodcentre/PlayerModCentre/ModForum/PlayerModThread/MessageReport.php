<?php
        ...
        if(isset($_POST['submit'])){
                ...
                $stmt = $conn->prepare("INSERT INTO reports (`date`,`message`,reported_by,replyID,threadID,thread_post) VALUES(?,?,?,?,?,?)");
                $stmt->bind_param("ssiiii",$report_date,$message,$current_user['userID'],$replyID,$reply['threadID'],$n);
                $stmt->execute();
                mysqli_close($conn);
                                                                                                        ...
                                                                                                        <tr>
                                                                                                                <td
                                                                                                                        ...
                                                                                                                        <center> <b>Runescape
                                                                                                                                ...
                                                                                                                                <br>
                                                                                                                                <textarea
                                                                                                                                        style="background-color:white; color:#000000; height:200px; width:500px" name="report"></textarea>
                                                                                                                                <center>
                                                                                                                                        <br><input
                                                                                                                                                value="Submit"
                                                                                                                                                id="codeButton"
