                                                                                                        ...
                                                                                                        <tr>
                                                                                                                <td
                                                                                                                        ...
                                                                                                                        <center><img class="imiddle"
                                                                                                                                ...
                                                                                                                                <br>
                                                                                                                                <center>
                                                                                                                                        <a href="AdminToolsReportAddNotes.php?reportID=<?php echo $reportID;?>"><input value="Add Notes" name="add" type="button""></a>&#8195;
                                                                                                                                        <a href="AdminToolsSendMessage.php?user=<?php echo urlencode($user['username']);?>&reportID=<?php echo $reportID;?>"><input value="Send Reply" name="send" title="Send Reply In Message Centre" type="button"></a>
