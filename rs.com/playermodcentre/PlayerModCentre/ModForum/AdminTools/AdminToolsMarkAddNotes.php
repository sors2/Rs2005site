...
if (isset($_POST["submit"])){
    ...
    $stmt = $conn->prepare("INSERT INTO marknotes (markID,author,note) VALUES (?,?,?)");
    $stmt->bind_param("iis",$markID,$user['userID'],$note);
    $stmt->execute();
    mysqli_close($conn);
    header("Location: ReadmarksView.php?markID=$markID");
}
                                                                                                        ...
                                                                                                        <tr>
                                                                                                                <td
                                                                                                                        ...
                                                                                                                        <center><img class="imiddle"
                                                                                                                                        title="Refresh"
                                                                                                                                        alt="Refresh"
                                                                                                                                        src="../Escalate/ReadReportsAddNotes_files/refresh.png"
                                                                                                                                        border="0"
                                                                                                                                        height="13"
                                                                                                                                        hspace="0"
                                                                                                                                        width="13">
                                                                                                                                <b>Forum Profile
                                                                                                                                        ...
                                                                                                                                        Notes</b>
                                                                                                                                <br>
                                                                                                                                <a href="AdminToolsMarkedMessagesView.php?markID=<?php echo $markID;?>"
                                                                                                                                        class="c">Back
                                                                                                                                        to
                                                                                                                                        Read
                                                                                                                                        Marks</a>
                                                                                                                                ...
                                                                                                                                <center><input value="Submit"
                                                                                                                                        ...
                                                                                                                                        <br>
                                                                                                                                        <center><a href="AdminToolsMarkedMessagesView.php?markID=<?php echo $markID;?>"
                                                                                                                                                        class="c">Back
                                                                                                                                                        to
                                                                                                                                                        Read
                                                                                                                                                        Marks</a>
