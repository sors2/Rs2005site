...
$result = mysqli_query($conn,"SELECT reportID,`date`,report_type,reported_by,replyID,`status`,accepted_by FROM reports ORDER BY `status` LIMIT $start_num,$posts_per_page ");
$reports=[];
...
{   
    ...
    $reports[]= '<tr>
                <td align="left">'.$date_format.'
                <td align="left" width="150px">'.$row['report_type'].'</td>
                <td align="left" width="100px">'.$accepted.'</td>
                <td align="left" width="100px">'.$status.'</td>
                <td></td><!-- Col 4 -->
                <td align="right"><a href="../Escalate/ReadReportsView.php?reportID='.$row['reportID'].'">View</a></td><!-- Col 5 -->
                </tr>';
}
?>
...
<div style="height:5px;"></div><center><img src="../PlayerModTools/PlayerModQuote_files/refresh.png" width="13" height="13" alt="" title="" /> <b>Admin Tools - Reports &amp; Marked Messages</b>
<br><a href="AdminTools.php">Back to Admin Tools</a></center>
<br><div style="float:left; text-align:left;"><b>Reports:</b>
<table style="height:100px" border="0" width="500px">
  <tbody>
  <tr><!-- Row 1 -->
                <td align="left"  width="100px"><b>Date</b></td>
                <td align="left" width="150px"><b>Type</b></td>
                <td align="left" width="100px"><b>Accpted By</b></td>
