...
if(!isset($_GET['page'])){
        ...
        $result = mysqli_query($conn,"SELECT * FROM bandetails");
        ...
        $result = mysqli_query($conn,"SELECT * FROM bandetails LIMIT $start_num,$posts_per_page");
        $bans=[];
        while($row = mysqli_fetch_assoc($result))
        {   
                $stmt = $conn->prepare("UPDATE bandetails SET `page` = ? WHERE banID = ?");
                $stmt->bind_param("ii", $page,$row['banID']);
                $stmt->execute(); 
                ...
                $bans[]= '<tr>
                                ...
                                <td align="left" width="200px">'.$row['rule'].'</td>
                                <td align="left" width="150px">'.$type.'</td><!-- Col 3 -->
                                <td></td><!-- Col 4 -->
                                <td align="left"><a href="AdminToolsViewInfractions.php?banID='.$row['banID'].'">View</a></td><!-- Col 5 -->
                                </tr>';
        }
        mysqli_close($conn);
...
<div style="height:5px;"></div><center><img src="../PlayerModTools/PlayerModQuote_files/refresh.png" width="13" height="13" alt="" title="" /> <b>Admin Tools - Infractions</b>
<br><a href="AdminTools.php">Back to Admin Tools</a></center>
<br><div style="float:left; text-align:left;"><center><b>Infractions:</b><center><br>
<table style="height:100px" border="0" width="500px">
  <tbody>
  <tr><!-- Row 1 -->
                <td align="left" width="100px"><b>Username</b></td>
                <td align="left" width="200px"><b>Date</b></td>
                <td align="left" width="200px"><b>Offense</b></td>
  ...
  <?php
        ...
        {
                echo '<br><div style="margin-bottom: 4%; margin-top: 1%; padding-left:30%;"><span style="float: left; text-align: center; margin-left: 1%; margin-right: 1%; width: 6%;"><a style =" margin-bottom: 10%; " href="AdminToolsInfractions.php?page=1"> <img src="AdminToolsReports&amp;MarkedMessages_files/first.png" width="26" height="13" alt="" title="" /></a></span><span style="float: left; text-align: center; margin-left: 1%; margin-right: 1%; width: 6%;"><a style =" margin-bottom: 10%; " href="AdminToolsInfractions.php?&page=' . $prev . '"> <img src="AdminToolsReports&amp;MarkedMessages_files/previous.png" width="26" height="13" alt="" title="" /> </a></span><span style="float:left; margin-left:2%;"> page </span><span style="float: left; text-align: center; border :2px solid rgb(222,222,222); border-style: inset; margin-left: 1%; margin-right: 1%; width: 6%;">' . $page . '</span><span style="float : left" >of '.$num_per_pages.'</span></div>';     
        }
        elseif($page == 1)
        {
                if($num_per_pages > 1)
                {
                        echo '<br><div style=" margin-bottom: 4%; padding-left:40%; margin-top: 1%;"><span style="float:left; margin-left:2%;"> page </span><span style="float: left; text-align: center; border :2px solid rgb(222,222,222); border-style: inset; margin-left: 1%; margin-right: 1%; width: 6%;">' . $page . '</span><span style="float : left" >of '.$num_per_pages.'</span><span style="float: left; text-align: center; margin-left: 1%; margin-right: 1%; width: 6%;"><a style =" margin-bottom: 10%; " href="AdminToolsInfractions.php?&page=' . $next . '"><img src="AdminToolsReports&amp;MarkedMessages_files/next.png" width="26" height="13" alt="" title="" /></a></span><span style="float: left; text-align: center; margin-left: 3%; margin-right: 1%; width: 6%;"><a style =" margin-bottom: 10%; " href="AdminToolsInfractions.php?&page=' . $num_per_pages. '"><img src="AdminToolsReports&amp;MarkedMessages_files/last.png" width="26" height="13" alt="" title="" /></a></span></div>'; 
                }
                else{
                ...
                echo '<br><div style=" margin-bottom: 4%; padding-left:30%; margin-top: 1%;"><span style="float: left; text-align: center; margin-left: 1%; margin-right: 1%; width: 6%;"><a style =" margin-bottom: 10%; " href="ThreadView.php?&page=1"><img src="AdminToolsReports&amp;MarkedMessages_files/first.png" width="26" height="13" alt="" title="" /></a></span><span style="float: left; text-align: center; margin-left: 1%; margin-right: 1%; width: 6%;"><a style =" margin-bottom: 10%; " href="AdminToolsInfractions.php?&page=' . $prev . '"> <img src="AdminToolsReports&amp;MarkedMessages_files/previous.png" width="26" height="13" alt="" title="" /> </a></span><span style="float:left; margin-left:2%;"> page </span><span style="float: left; text-align: center; border :2px solid rgb(222,222,222); border-style: inset; margin-left: 1%; margin-right: 1%; width: 6%;">' . $page . '</span><span style="float : left" >of '.$num_per_pages.'</span><span style="float: left; text-align: center; margin-left: 1%; margin-right: 1%; width: 6%;"><a style =" margin-bottom: 10%; " href="AdminToolsInfractions.php?&page=' . $next . '"><img src="AdminToolsReports&amp;MarkedMessages_files/next.png" width="26" height="13" alt="" title="" /></a></span><span style="float: left; text-align: center; margin-left: 1%; margin-right: 1%; width: 6%;"><a style =" margin-bottom: 10%; " href="AdminToolsInfractions.php?&page=' . $num_per_pages. '"><img src="AdminToolsReports&amp;MarkedMessages_files/last.png" width="26" height="13" alt="" title="" /></a></span></div>';     
        }
?>
    </tr>
</tbody></table>   
