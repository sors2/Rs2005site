...
<br>
    <a href="AdminToolsReports&MarkedMessages.php" class="c">Back to Reports & Marked Messages</a>
...
<table style="height:50px" border="0" width="100%">
  ...
  <tr><!-- Row 2 -->
     <td valign="top"><img src="AdminTools_files/thread.png" alt="" title="" height="13" width="13"></td><!-- Col 1 -->
