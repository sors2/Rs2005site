...
$result= mysqli_query($conn, "SELECT * FROM banappeals");
...
$result = mysqli_query($conn,"SELECT * FROM banappeals LIMIT $start_num,$posts_per_page");
$bans=[];
while($row = mysqli_fetch_assoc($result))
{   

    $stmt = $conn->prepare("UPDATE banappeals SET `page` = ? WHERE appealID = ?");
    $stmt->bind_param("ii", $page,$row['appealID']);
    $stmt->execute(); 
    ...
    $appeal = htmlspecialchars_decode($row['appeal']);
    $appeal = substr($appeal,0,20).'...';
    ...
    $bans[]= '<tr>
                ...
                <td align="left" width="200px">'.$appeal.'</td>
                <td align="left" width="100px">'.$status.'</td>
                <td></td><!-- Col 4 -->
                <td align="right"><a href="AdminToolsBanAppealsView.php?appealID='.$row['appealID'].'">View</a></td><!-- Col 5 -->
                </tr>';
}
?>
...
<div style="height:5px;"></div><center><img src="../PlayerModTools/PlayerModQuote_files/refresh.png" width="13" height="13" alt="" title="" /> <b>Admin Tools - Ban Appeals</b>
<br><a href="AdminTools.php">Back to Admin Tools</a></center>
<br><div style="float:left; text-align:left;"><b>Ban Appeals:</b>
<table style="height:100px" border="0" width="500px">
  ...
  <tr><!-- Row 1 -->
                ...
                <td align="left" width="300px"><b>Appeal</b></td>
  ...
  <?php
        ...
        {
                echo '<br><div style="margin-bottom: 4%; margin-top: 1%; padding-left:30%;"><span style="float: left; text-align: center; margin-left: 1%; margin-right: 1%; width: 6%;"><a style =" margin-bottom: 10%; " href="AdminToolsBanAppeals.php?page=1"> <img src="AdminToolsReports&amp;MarkedMessages_files/first.png" width="26" height="13" alt="" title="" /></a></span><span style="float: left; text-align: center; margin-left: 1%; margin-right: 1%; width: 6%;"><a style =" margin-bottom: 10%; " href="AdminToolsBanAppeals.php?&page=' . $prev . '"> <img src="AdminToolsReports&amp;MarkedMessages_files/previous.png" width="26" height="13" alt="" title="" /> </a></span><span style="float:left; margin-left:2%;"> page </span><span style="float: left; text-align: center; border :2px solid rgb(222,222,222); border-style: inset; margin-left: 1%; margin-right: 1%; width: 6%;">' . $page . '</span><span style="float : left" >of '.$num_per_pages.'</span></div>';     
        }
        elseif($page == 1)
        {
                if($num_per_pages > 1)
                {
                        echo '<br><div style=" margin-bottom: 4%; padding-left:40%; margin-top: 1%;"><span style="float:left; margin-left:2%;"> page </span><span style="float: left; text-align: center; border :2px solid rgb(222,222,222); border-style: inset; margin-left: 1%; margin-right: 1%; width: 6%;">' . $page . '</span><span style="float : left" >of '.$num_per_pages.'</span><span style="float: left; text-align: center; margin-left: 1%; margin-right: 1%; width: 6%;"><a style =" margin-bottom: 10%; " href="AdminToolsBanAppeals.php?&page=' . $next . '"><img src="AdminToolsReports&amp;MarkedMessages_files/next.png" width="26" height="13" alt="" title="" /></a></span><span style="float: left; text-align: center; margin-left: 3%; margin-right: 1%; width: 6%;"><a style =" margin-bottom: 10%; " href="AdminToolsReports.php?&page=' . $num_per_pages. '"><img src="AdminToolsReports&amp;MarkedMessages_files/last.png" width="26" height="13" alt="" title="" /></a></span></div>'; 
                }
                else{
                ...
                echo '<br><div style=" margin-bottom: 4%; padding-left:30%; margin-top: 1%;"><span style="float: left; text-align: center; margin-left: 1%; margin-right: 1%; width: 6%;"><a style =" margin-bottom: 10%; " href="ThreadView.php?&page=1"><img src="AdminToolsReports&amp;MarkedMessages_files/first.png" width="26" height="13" alt="" title="" /></a></span><span style="float: left; text-align: center; margin-left: 1%; margin-right: 1%; width: 6%;"><a style =" margin-bottom: 10%; " href="AdminToolsBanAppeals.php?&page=' . $prev . '"> <img src="AdminToolsReports&amp;MarkedMessages_files/previous.png" width="26" height="13" alt="" title="" /> </a></span><span style="float:left; margin-left:2%;"> page </span><span style="float: left; text-align: center; border :2px solid rgb(222,222,222); border-style: inset; margin-left: 1%; margin-right: 1%; width: 6%;">' . $page . '</span><span style="float : left" >of '.$num_per_pages.'</span><span style="float: left; text-align: center; margin-left: 1%; margin-right: 1%; width: 6%;"><a style =" margin-bottom: 10%; " href="AdminToolsBanAppeals.php?&page=' . $next . '"><img src="AdminToolsReports&amp;MarkedMessages_files/next.png" width="26" height="13" alt="" title="" /></a></span><span style="float: left; text-align: center; margin-left: 1%; margin-right: 1%; width: 6%;"><a style =" margin-bottom: 10%; " href="AdminToolsBanAppeals.php?&page=' . $num_per_pages. '"><img src="AdminToolsReports&amp;MarkedMessages_files/last.png" width="26" height="13" alt="" title="" /></a></span></div>';     
        }
?>
    </tr>
</tbody></table>   
