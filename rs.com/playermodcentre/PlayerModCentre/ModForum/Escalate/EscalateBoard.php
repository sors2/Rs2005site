                                                                                                                ...
                                                                                                                <td
                                                                                                                        ...
                                                                                                                        <center><img class="imiddle"
                                                                                                                                ...
                                                                                                                                <b>Runescape
                                                                                                                                        Forums
                                                                                                                                        -
                                                                                                                                        <?php echo $thread["category"];?> - <?php echo $thread["title"];?></b> <?php echo $sticky;?><?php echo $locked;?>
                                                                                                                                <br><b>Escalate
                                                                                                                                        Thread</b>
                                                                                                                                <br><a href="../../../../forums/ForumBoard/forumboard.php?category=<?php echo urlencode($thread['category']);?>&page=<?php echo $thread['page'];?>"
                                                                                                                                        class="c">Back
                                                                                                                                        to
                                                                                                                                        threads
                                                                                                                                        page</a>
                                                                                                                                                ...
                                                                                                                                                <tr>
                                                                                                                                                        ...
                                                                                                                                                        <td class="e" align="center">
                                                                                                                                                            ...
                                                                                                                                                            <a href="../../../../forums/forumMessages/EditOPMessage.php?threadID=<?php echo $_GET['threadID'];?>" class="c">Edit Title</a>&#8195;
                                                                                                                                                                ...
                                                                                                                                                                <?php if($thread['isSticky'] == 1):?><a href="../PlayerModBoard/UnstickyBoard.php?threadID=<?php echo $_GET['threadID'];?>" class="c">Unsticky</a><?php else:?><a href="../PlayerModBoard/StickyBoard.php?threadID=<?php echo $_GET['threadID'];?>" class="c">Sticky</a><?php endif?>&#8195;
                                                                                                                                                                <?php if($thread['isLocked'] == 1):?><a href="../PlayerModBoard/UnlockBoard.php?threadID=<?php echo $_GET['threadID'];?>" class="c">Unlock</a><?php else:?><a href="../PlayerModBoard/LockBoard.php?threadID=<?php echo $_GET['threadID'];?>" class="c">Lock</a><?php endif?>&#8195;
                                                                                                                                                                <?php if($thread['hidden'] == 1):?><a href="../PlayerModBoard/UnhideBoard.php?threadID=<?php echo $_GET['threadID'];?>" class="c">Unhide</a><?php else:?><a href="../PlayerModBoard/HideBoard.php?threadID=<?php echo $_GET['threadID'];?>" class="c">Hide</a><?php endif?>&#8195;
                                                                                                                                                                <?php if ($current_user['rolesID'] > 2):?>
                                                                                                                                                                <a href="../PlayerModBoard/DeleteThread.php?threadID=<?php echo $_GET['threadID'];?>">Delete Thread</a>&#8195;
                                                                                                                                                                <?php endif?>
                                                                                                                                                                <br><a href="../PlayerModBoard/BoardReport.php?threadID=<?php echo $_GET['threadID'];?>" class="c">Report</a>&#8195;
                                                                                                                                                                <a href="../PlayerModBoard/BoardMark.php?threadID=<?php echo $_GET['threadID'];?>" class="c">Mark</a> &#8195;
                                                                                                                                                                <a href="ReadReports.php?category=<?php echo ($_GET['threadID']);?>" class="c">Read Reports</a>&#8195;
                                                                                                                                                                <a href="RecentInfractions.htm" class="c">Recent Infractions</a>
                                                                                                                                                                <br>
                                                                                                                                                                <form action="CheckMove.php" method="POST">
                                                                                                                                                                        <select
                                                                                                                                                                                name="srcfrm">
                                                                                                                                ...
                                                                                                                                <br>
                                                                                                                                <center><a href="../../../../forums/ForumBoard/forumboard.php?category=<?php echo urlencode($thread['category']);?>&page=<?php echo $thread['page'];?>"
                                                                                                                                                class="c">Back
                                                                                                                                                to
                                                                                                                                                threads
                                                                                                                                                page</a>
