...
<head>
        ...
        <link media="all" type="text/css" rel="stylesheet" href="OtherQuerySubmit_files/main.css">
        <link href="OtherQuerySubmit_files/forum-3.css" rel="stylesheet" type="text/css" media="all">
</head>
<div class="pagealign">
                                                ...
                                                <center>
                                                        <table cellpadding="0" cellspacing="0">
                                                                <tbody>
                                                                        <tr>
                                                                                <td valign="top"><img
                                                                                                src="OtherQuerySubmit_files/edge_a.jpg"
                                                                                                height="43" hspace="0"
                                                                                                vspace="0" width="100">
                                                                                </td>
                                                                                <td valign="top"><img
                                                                                                src="OtherQuerySubmit_files/edge_c.jpg"
                                                                                                height="42" hspace="0"
                                                                                                vspace="0" width="400">
                                                                                </td>
                                                                                <td valign="top"><img
                                                                                                src="OtherQuerySubmit_files/edge_d.jpg"
                                                                                                height="43" hspace="0"
                                                                                                vspace="0" width="100">
                                                                                </td>
                                                                        </tr>
                                                        ...
                                                        <table background="OtherQuerySubmit_files/background2.jpg"
                                                        ...
                                                        <table cellpadding="0" cellspacing="0">
                                                                <tbody>
                                                                        <tr>
                                                                                <td valign="bottom">
                                                                                        <img src="OtherQuerySubmit_files/edge_g2.jpg"
                                                                                                height="82" hspace="0"
                                                                                                vspace="0" width="100">
                                                                                </td>
                                                                                <td valign="bottom">
                                                                                        <div style="font-family:Arial,Helvetica,sans-serif; font-size:11px;"
                                                                                                ...
                                                                                                This webpage and its
                                                                                                contents is copyright
                                                                                                2005
                                                                                                Jagex Ltd<br>
                                                                                        ...
                                                                                        <img src="OtherQuerySubmit_files/edge_c.jpg"
                                                                                                height="42" hspace="0"
                                                                                                vspace="0" width="400">
                                                                                </td>
                                                                                <td valign="bottom">
                                                                                        <img src="OtherQuerySubmit_files/edge_h2.jpg"
                                                                                                height="82" hspace="0"
                                                                                                vspace="0" width="100">
                                                                                </td>
                                                                        </tr>
