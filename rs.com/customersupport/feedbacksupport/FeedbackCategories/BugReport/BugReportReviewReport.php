<?php 
session_start();
if(!isset($_SESSION['bug_category']) || !isset($_SESSION['title']) || !isset($_SESSION['report'])){
   header('Location: BugReportSelectCategory.php');
}
...
if(isset($_POST['review'])){
   ...
   $stmt = $conn->prepare("INSERT INTO bugreports (userID,category,`date`,title, bugreport) VALUES (?,?,?,?,?)");
   $stmt->bind_param("issss",$user['userID'],$_SESSION['bug_category'],$date,$_SESSION['title'],$_SESSION['report']);
   $stmt->execute();

   unset($_SESSION['bug_category']);
   unset($_SESSION['title']);
   unset($_SESSION['report']);

   header("Location: BugReportSubmitReport.php");
}
?>
...
<head>
   ...
   <link media="all" type="text/css" rel="stylesheet" href="BugReportReviewReport_files/main.css">
   <link href="BugReportReviewReport_files/forum-3.css" rel="stylesheet" type="text/css" media="all">
</head>
<div class="pagealign">
               ...
               <td valign="middle">
                  <center>
                     <table cellpadding="0" cellspacing="0">
                        <tbody>
                           <tr>
                              <td valign="top"><img src="BugReportReviewReport_files/edge_a.jpg" height="43" hspace="0"
                                    vspace="0" width="100"></td>
                              <td valign="top"><img src="BugReportReviewReport_files/edge_c.jpg" height="42" hspace="0"
                                    vspace="0" width="400"></td>
                              <td valign="top"><img src="BugReportReviewReport_files/edge_d.jpg" height="43" hspace="0"
                                    vspace="0" width="100"></td>
                           </tr>
                        </tbody>
                     </table>
                     <table background="BugReportReviewReport_files/background2.jpg" border="0" cellpadding="0"
                                                   ...
                                                   <tbody>
                                                      <tr>
                                                         ...
                                                         <td bgcolor="35210F" height="26">
                                                            <font color="#FFBB22">Review Report</font>
                                                         </td>
                                                         <!-- Col 9 -->
                                                         <td>&gt;</td>
                                                         <!-- Col 10 -->
                                                      ...
                                                      <tr>
                                                         ...
                                                         <td>
                                                            <div style="float: left; text-align: left;">
                                                               Here you can review your bug report. If you'd like to
                                                               make any changes, you may go <a
                                                                  href="BugReportCompleteReport.php">back</a>
                                                               after reviewing your report to make changes if you need
                                                               to.
                                                               <br><br>Review Bug Report:
                                                               <br>
                                                               <form action="BugReportSubmitReport.php" method="POST">
                                                               <br>Title:<span id="title"><?php echo $_SESSION['title'];?>
                                                               <br>Report:<span id="bugreport"><?php echo $_SESSION['report'];?>
                                                                </form>
                                                               <br>
                                                               <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" method="POST">
                                                               <center><input value="Submit" type="submit" name="review"></center>
                                                               </form>
                                                            </div>
                                                         </td>
                                                         <!-- Col 1 -->
                     ...
                     <table cellpadding="0" cellspacing="0">
                        <tbody>
                           <tr>
                              <td valign="bottom">
                                 <img src="BugReportReviewReport_files/edge_g2.jpg" height="82" hspace="0" vspace="0"
                                    width="100">
                              </td>
                              <td valign="bottom">
                                 ...
                                 <img src="BugReportReviewReport_files/edge_c.jpg" height="42" hspace="0" vspace="0"
                                    width="400">
                              </td>
                              <td valign="bottom">
                                 <img src="BugReportReviewReport_files/edge_h2.jpg" height="82" hspace="0" vspace="0"
                                    width="100">
                              </td>
                           </tr>
                        </tbody>
