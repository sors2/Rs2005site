...
if(isset($_POST['category'])){
   $_SESSION['bug_category'] = $_POST['category'];
}
...
<head>
   ...
   <link media="all" type="text/css" rel="stylesheet" href="BugReportCheckCommonBugs_files/main.css">
   <link href="BugReportCheckCommonBugs_files/forum-3.css" rel="stylesheet" type="text/css" media="all">
</head>
<div class="pagealign">
               ...
               <td valign="middle">
                  <center>
                     <table cellpadding="0" cellspacing="0">
                        <tbody>
                           <tr>
                              <td valign="top"><img src="BugReportCheckCommonBugs_files/edge_a.jpg" height="43"
                                    hspace="0" vspace="0" width="100"></td>
                              <td valign="top"><img src="BugReportCheckCommonBugs_files/edge_c.jpg" height="42"
                                    hspace="0" vspace="0" width="400"></td>
                              <td valign="top"><img src="BugReportCheckCommonBugs_files/edge_d.jpg" height="43"
                                    hspace="0" vspace="0" width="100"></td>
                           </tr>
                        </tbody>
                     </table>
                     <table background="BugReportCheckCommonBugs_files/background2.jpg" border="0" cellpadding="0"
                                       ...
                                       <tbody>
                                          <tr>
                                             <td class="e">
                                                ...
                                                <table border="0" width="500px" style="height:0px">
                                                   <tbody>
                                                      <tr>
                                                         <!-- Row 1 -->
                                                         ...
                                                         <td bgcolor="35210F" height="26">
                                                            <font color="#FFBB22">Check Common Bugs</font>
                                                         </td>
                                                         <!-- Col 3 -->
                                                         <td>&gt;</td>
                                                         <!-- Col 4 -->
                                                      ...
                                                      <tr>
                                                         ...
                                                         <td>
                                                            <div style="float: left; text-align: left;">
                                                               Here you will find common bugs to check for. If the bug
                                                               you are reporting is in the list, there is no need to
                                                               report it.
                                                               <br>
                                                               <ul>
                                                                  <li>
                                                               ...
                                                               <center><a href="BugReportCheckMistakenBugs.php"><input value="Continue" type="button"></a>
                                                               </center>
                                                            </div>
                                                         </td>
                                                         <!-- Col 1 -->
                     ...
                     <table cellpadding="0" cellspacing="0">
                        <tbody>
                           <tr>
                              <td valign="bottom">
                                 <img src="BugReportCheckCommonBugs_files/edge_g2.jpg" height="82" hspace="0" vspace="0"
                                    width="100">
                              </td>
                              <td valign="bottom">
                                 ...
                                 <img src="BugReportCheckCommonBugs_files/edge_c.jpg" height="42" hspace="0" vspace="0"
                                    width="400">
                              </td>
                              <td valign="bottom">
                                 <img src="BugReportCheckCommonBugs_files/edge_h2.jpg" height="82" hspace="0" vspace="0"
                                    width="100">
                              </td>
                           </tr>
                        </tbody>
