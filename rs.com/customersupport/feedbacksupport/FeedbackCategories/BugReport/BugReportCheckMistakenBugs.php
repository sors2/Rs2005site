...
<head>
   ...
   <link media="all" type="text/css" rel="stylesheet" href="BugReportCheckMistakenBugs_files/main.css">
   <link href="BugReportCheckMistakenBugs_files/forum-3.css" rel="stylesheet" type="text/css" media="all">
</head>
<div class="pagealign">
               ...
               <td valign="middle">
                  <center>
                     <table cellpadding="0" cellspacing="0">
                        <tbody>
                           <tr>
                              <td valign="top"><img src="BugReportCheckMistakenBugs_files/edge_a.jpg" height="43"
                                    hspace="0" vspace="0" width="100"></td>
                              <td valign="top"><img src="BugReportCheckMistakenBugs_files/edge_c.jpg" height="42"
                                    hspace="0" vspace="0" width="400"></td>
                              <td valign="top"><img src="BugReportCheckMistakenBugs_files/edge_d.jpg" height="43"
                                    hspace="0" vspace="0" width="100"></td>
                           </tr>
                        </tbody>
                     </table>
                     <table background="BugReportCheckMistakenBugs_files/background2.jpg" border="0" cellpadding="0"
                                                   ...
                                                   <tbody>
                                                      <tr>
                                                         ...
                                                         <td bgcolor="35210F" height="26">
                                                            <font color="#FFBB22">Check Mistaken Cases</font>
                                                         </td>
                                                         <!-- Col 5 -->
                                                         <td>&gt;</td>
                                                         <!-- Col 6 -->
                                                      ...
                                                      <tr>
                                                         ...
                                                         <td>
                                                            <div style="float: left; text-align: left;">
                                                               Here you will find a list of mistaken bugs. Please do
                                                               <b>not</b> report anything found on this list, as this is
                                                               not a bug.
                                                               <br>
                                                               <ul>
                                                                  <li>
                                                               ...
                                                               <center><a href="BugReportCompleteReport.php"><input value="Continue" type="button"></a>
                                                               </center>
                                                            </div>
                                                         </td>
                                                         <!-- Col 1 -->
                     ...
                     <table cellpadding="0" cellspacing="0">
                        <tbody>
                           <tr>
                              <td valign="bottom">
                                 <img src="BugReportCheckMistakenBugs_files/edge_g2.jpg" height="82" hspace="0"
                                    vspace="0" width="100">
                              </td>
                              <td valign="bottom">
                                 ...
                                 <img src="BugReportCheckMistakenBugs_files/edge_c.jpg" height="42" hspace="0"
                                    vspace="0" width="400">
                              </td>
                              <td valign="bottom">
                                 <img src="BugReportCheckMistakenBugs_files/edge_h2.jpg" height="82" hspace="0"
                                    vspace="0" width="100">
                              </td>
                           </tr>
                        </tbody>
