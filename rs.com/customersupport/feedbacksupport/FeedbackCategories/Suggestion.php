...
<center><br>
        <table bgcolor="black" border="0" cellpadding="5" width="500">
                <tbody>
                        <tr>
                                <td class="e">  
                                        <div style="float: left; text-align: left;">Use this form for suggestions or ideas for the game.
                                        <br>If your query is not a suggestion or idea, please <a href="../Feedback.php" class="c">select another category</a>
                                        <br>
                                        <br>Your suggestion/idea:
